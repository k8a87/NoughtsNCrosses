...
const winnerBackground = function (pos) {
  pos.classList.remove("bg--circle", "bg--cross", "bg--square");
...
//For every square element, check first if game is active and that there are no active squares (So you can't click on the same square twice). Then check which player is active.
for (let i = 0; i < square.length; i++) {
  square[i].addEventListener("click", function () {
    if (
      gameActive &&
      !square[i].classList.contains("oWin") &&
      !square[i].classList.contains("xWin")
    ) {
      if (activePlayer === 0) {
        iconEl[i].classList.add("far", "fa-circle");
        square[i].classList.remove("bg--square");
        square[i].classList.add("bg--circle");
        square[i].classList.add("oWin");
        ...
        !square[i].classList.contains("bg--winner")
          ? draw()
          : console.log("Game on");
        //switch players
        ...
        square[i].classList.remove("bg--square");
        square[i].classList.add("bg--cross");
        square[i].classList.add("xWin");
